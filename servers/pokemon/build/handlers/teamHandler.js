...
exports.getTeamHandler = (request, response, { BattlePokemonModel }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // if the user already caught the pokemon, then get its information
        const user = JSON.parse(request.header(XUser));
        const pokemons = yield BattlePokemonModel.find({ owner_id: user.id });
